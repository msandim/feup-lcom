...
int rtc_get_data(date_info *data)
{
  ...
  rtc_load_info(RTC_REG_MINUTES,&data->minutes);
  rtc_load_info(RTC_REG_HOURS,&data->hours);
  rtc_load_info(RTC_REG_WEEK_DAY,&data->week_day);
  rtc_load_info(RTC_REG_MONTH_DAY,&data->month_day);
  rtc_load_info(RTC_REG_MONTH,&data->month);
  rtc_load_info(RTC_REG_YEAR,&data->year);
...
int rtc_set_alarm(date_info data)
{
  ...
  rtc_save_info(RTC_REG_MINUTES_ALARM,data.minutes);
  rtc_save_info(RTC_REG_HOURS_ALARM,data.hours);
