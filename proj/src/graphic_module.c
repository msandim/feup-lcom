...
//
//unsigned short* loadDrawingInfo (char const* filename, HEADER* head, INFOHEADER* info) {
//
//	// allocate memory for the file name
//	char* path = (char*) malloc ( (strlen(filename) + 24) * sizeof (char));
//
//	snprintf (path, (strlen(filename) + 24), "/home/lcom/proj/drawings/%s", filename);
//
//	//printf("FILE:\n%s\n",path);
//
//	// Open file
...
//unsigned short* saveDrawing (char const* filename, unsigned short* image, unsigned int * width, unsigned int * height) {
//
//	// allocate memory for the file name
//	char* path = (char*) malloc ( (strlen(filename) + 24) * sizeof (char));
//
...
//	INFOHEADER info;
//
//	drawings = fopen("/home/lcom/proj/drawings/drawings",mode);
//
//	if (drawings == NULL) {
//		printf("Cannot open file!\n");
//		free (path);
