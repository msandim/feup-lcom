...
void (*tool_handlers[1]) (void) = {rectagle_handler} ; // 2 ferramentas por agora (pincel, linha reta)
			...
			case HARDWARE:
				...
				if (msg.NOTIFY_ARG & irq_set_timer) {
					...
					if (timer_count%2 == 0){
						...
						set_graphicsDrawMode(draw_screen,btn_array,color_bar); // desenhar tudo
